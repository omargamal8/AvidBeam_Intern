...
# Form implementation generated from reading ui file 'Media_Sources.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.listWidget.setGeometry(QtCore.QRect(10, 60, 256, 371))
        self.listWidget.setObjectName(_fromUtf8("listWidget"))
        self.widget = QtGui.QWidget(Dialog)
        self.widget.setGeometry(QtCore.QRect(320, 130, 261, 241))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Media Sources", None))
