...
def scanning(pids):
    ...
    File_Name = '/home/avidbeam/dimensioning-tool/HW_Test.txt'
...
#    total= float(avgcpuf) * logCores
    ...
    elements.append(t)
    doc.build(elements)
    path = r'/home/avidbeam/dimensioning-tool/hwEstimate.pdf'
...
#    total= avgcpuf * CPU_No
    ...
    new_path = r'/home/avidbeam/dimensioning-tool/hwConfiguration.pdf'
